...
/** 
 * The maximum number of foods that the customer can choose is two.
 * The duration of the selected foods should be added to the customer's time.
 * @author Merve Ozer
 */
public interface FoodChooser {

	public default void chooseFood(Random random, Customer customer) {
		...
		System.out.println(customer + " choose a " + food.getName() + ". Preparation time:" + food.getPrepareTimeMS() + ". Eating time:" + food.getConsumeTimeMS());	
