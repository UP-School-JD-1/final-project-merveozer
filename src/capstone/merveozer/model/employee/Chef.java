...
/**
 * Only the best chef in the world works in the restaurant.
 * So make sure there is only one instance of chef. (That's why the singleton was used)
 * @author Merve Ozer
 */
...
public class Chef {
	...
	public void cook(Waiter waiter) {
		...
		try {
			semaphore.acquire();
			System.out.println(waiter + " reported " + waiter.customer + " 's order. It will be ready in " +  waiter.customer.getTotalPrepareTimeMS() + " MS");
